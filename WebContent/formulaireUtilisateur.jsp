	...
	<div class="wrapper fadeInDown">
		<div id="formContent">
			<form action="/TestServletJPA/creationUtilisateur" method="post">
				...
				<input type="email" id="emailUtilisateur" name="emailUtilisateur" size="30" maxlength="60" class="fadeIn second" placeholder="email"/>
				<br />       
				
			    <label	for="passwordUtilisateur">Password (8 characters minimum):</label> 
				<input	type="password" id="pass" name="passwordUtilisateur" size="30" maxlength="60" required class="fadeIn third" placeholder="password"/>
				<br />
